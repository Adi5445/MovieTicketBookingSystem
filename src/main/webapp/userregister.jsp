...
<div class="form-group"> 
             <table align="center" cellpadding="5" cellspacing="5" width="400">
              <tr> 
                ...
                <input type="text" class="form-control" name="first_name" id = "firstname" onblur = "enableRegisterButton();" style="width: 250px;" required></td>
				<td><font size="+1" color=#b41685><strong>Last Name</strong>*</font><br>
                <input type="text" class="form-control" name="last_name" id = "lastname" onblur = "enableRegisterButton();" style="width: 250px;" required></td>	
              </tr>
			  </TABLE>
			...
			<table align="center" cellpadding="5" cellspacing="5" width="400">
			  <tr> 
				...
				<br>
				<input type="text" class="form-control" name="address" id = "address" onblur = "enableRegisterButton();" style="width: 500px;"	required >
              </tr>
              <tr> 
               </table>
			  ...
			  <tr> 
				...
				<br>
				<input type="password" class="form-control" name="password" id="password" onblur = "enableRegisterButton();" style="width: 250px;" required	 >
				<td>
				<font size="+1"color=#b41685><strong>Confirm Password</strong>*</font>
				<br>
				<input type="password" class="form-control" name="confirmpassword" id="confirmpassword" onblur = "enableRegisterButton();" style="width: 250px;" required	 >
